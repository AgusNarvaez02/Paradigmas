...
public class Deportista {
    ...
    public Deportista(String nombre, String dni) throws excepcionesDeportista{
        try {
            if(this.recorrer(dni)){
                throw new excepcionesDeportista(" Dni vacio");
            }
            else{
                this.dni = dni;}
            if(this.recorrer(nombre)){
                    throw new excepcionesDeportista(" Nombre vacio");
            }
            else{
                this.nombre = nombre;}
